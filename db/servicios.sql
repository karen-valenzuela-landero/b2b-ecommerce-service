...
VALUES(1,'Distribución de equipo de cómputo', 'Equipo de cómputo centralizado y descentralizado. 
...
Software de diseño gráfico, arquitectónico y de ingeniería (Autodesk, Adobe).', 'https://www.comoves.unam.mx/storage/revista/298/memes-ideas-que-se-contagian.jpg', '4'); 
  INSERT INTO servicios (idServicios,Nombre,Descripcion,Imagen,Usuarios_idUsuarios) 
  VALUES(3,'Servicios administrativos', 'Administramos y mantenemos tu red, almacenamiento de datos,seguridad informática, gestión de base de datos y soporte técnico."', 
'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSHhAsKnVXFrf4IvP5ATV-NNEn63PMFX3rfFK70ffFMe-G0_NB849qgJs-FpjUroEiKsr0&usqp=CAU','6'); 
 INSERT INTO servicios (idServicios,Nombre,Descripcion,Imagen,Usuarios_idUsuarios) 
  VALUES(4,'Implementación de Software de Caja', 'Adaptamos software de tipo ERP y CRM a las necesidades de ttu empresa.', 
'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSCTu5bVe4n5Qbwes2M7bCgWt2IjMx_zKCYg&usqp=CAU','7'); 
 INSERT INTO servicios (idServicios,Nombre,Descripcion,Imagen,Usuarios_idUsuarios) 
  VALUES(5,'Servicios Administrativos de la OnSite', 'Junto con los servicios en la nube, le proveemos del servicio de administración de esta desde su empresa.', 
